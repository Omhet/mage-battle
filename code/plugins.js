...
GA.plugins = function(ga) {
  ...
  */
  ...
  ga.rotateAroundSprite = function(
    rotatingSprite,
    centerSprite,
    distance,
    angle
    ...
    rotatingSprite.y =
      ...
      rotatingSprite.parent.y + //centerSprite.y
  ...
  */
  ...
  ga.fadeOut = function(sprite, frames) {
    ...
    return ga.tweenProperty(sprite, 'alpha', sprite.alpha, 0, frames, 'sine');
  };
  ...
  ga.fadeIn = function(sprite, frames) {
    if (frames === undefined) frames = 60;
    return ga.tweenProperty(sprite, 'alpha', sprite.alpha, 1, frames, 'sine');
  };
  ...
  */
  ...
  ga.walkCurve = function(
    ...
    function makePath(currentCurve) {
      ...
      var tween = ga.followCurve(sprite, pathArray[currentCurve], frames, type);
  ...
  */
  ...
  ga.particleEffect = function(
    ...
    if (x === undefined) x = 0;
    if (y === undefined) y = 0;
    if (spriteFunction === undefined)
      spriteFunction = function() {
        return ga.circle(10, 'red');
      };
  ...
  */
  ...
  ga.burst = function(
    ...
    function makeParticle() {
      ...
      particle.rotationSpeed = ga.randomFloat(
        minRotationSpeed,
        maxRotationSpeed
      );
  ...
  */
  ...
  ga.makeTiledWorld = function(tiledMap, tileset) {
    ...
    var numberOfTilesetColumns = Math.floor(
    ...
    if (ga.canvas.width > ga.canvas.height) {
      ...
      if (ua.indexOf('safari') !== -1 || ua.indexOf('chrome') !== -1) {
        document.styleSheets[0].insertRule(
          'canvas:-webkit-full-screen {position: fixed; width: 100%; height: auto; top: 0; right: 0; bottom: 0; left: 0; margin: auto; object-fit: contain}',
          0
        );
      } else if (ua.indexOf('firefox') !== -1) {
        document.styleSheets[0].insertRule(
          'canvas:-moz-full-screen {position: fixed; width: 100%; height: auto; top: 0; right: 0; bottom: 0; left: 0; margin: auto; object-fit: contain;}',
          0
        );
      } else if (ua.indexOf('opera') !== -1) {
        document.styleSheets[0].insertRule(
          'canvas:-o-full-screen {position: fixed; width: 100%; height: auto; top: 0; right: 0; bottom: 0; left: 0; margin: auto; object-fit: contain;}',
          0
        );
      } else if (ua.indexOf('explorer') !== -1) {
        document.styleSheets[0].insertRule(
          'canvas:-ms-full-screen {position: fixed; width: 100%; height: auto; top: 0; right: 0; bottom: 0; left: 0; margin: auto; object-fit: contain;}',
          0
        );
      } else {
        document.styleSheets[0].insertRule(
          'canvas:fullscreen {position: fixed; width: 100%; height: auto; top: 0; right: 0; bottom: 0; left: 0; margin: auto; object-fit: contain;}',
          0
        );
      }
    } else {
      ...
      if (ua.indexOf('safari') !== -1 || ua.indexOf('chrome') !== -1) {
        document.styleSheets[0].insertRule(
          'canvas:-webkit-full-screen {height: 100%; margin: 0 auto; object-fit: contain;}',
          0
        );
      } else if (ua.indexOf('firefox') !== -1) {
        document.styleSheets[0].insertRule(
          'canvas:-moz-full-screen {height: 100%; margin: 0 auto; object-fit: contain;}',
          0
        );
      } else if (ua.indexOf('opera') !== -1) {
        document.styleSheets[0].insertRule(
          'canvas:-o-full-screen {height: 100%; margin: 0 auto; object-fit: contain;}',
          0
        );
      } else if (ua.indexOf('msie') !== -1) {
        document.styleSheets[0].insertRule(
          'canvas:-ms-full-screen {height: 100%; margin: 0 auto; object-fit: contain;}',
          0
        );
      } else {
        document.styleSheets[0].insertRule(
          'canvas:fullscreen {height: 100%; margin: 0 auto; object-fit: contain;}',
          0
        );
      }
    }
  ...
  */
  ga.soundEffect = function(
    ...
    function addReverb(volumeNode) {
      ...
      convolver.buffer = ga.impulseResponse(
        reverb[0],
        reverb[1],
        reverb[2],
        actx
